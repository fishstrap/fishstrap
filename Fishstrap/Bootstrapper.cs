...
using Fishstrap.Models.APIs;
using Fishstrap.Models.APIs.RoValra;
using Fishstrap.RobloxInterfaces;
using Fishstrap.UI.Elements.Bootstrapper.Base;
...
namespace Fishstrap
{
    public class Bootstrapper
    {
        ...
        public string MutexName { get; set; } = "Fishstrap-Bootstrapper";
        ...
        public async Task Run()
        {
            ...
            if (!_noConnection)
            {
                ...
                {
                    bool backgroundUpdaterMutexOpen = Utilities.DoesMutexExist("Fishstrap-BackgroundUpdater");
        ...
        private async Task StartRoblox()
        {
            ...
            if (App.Settings.Prop.EnableActivityTracking || App.Settings.Prop.EnableWindowManipulation || App.Settings.Prop.KillRobloxOnWindowClose || App.LaunchSettings.TestModeFlag.Active || autoclosePids.Any())
            {
        ...
        private async Task<bool> CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one Fishstrap instance running, aborting update check");
                return false;
            }
            ...
            SetStatus(Strings.Bootstrapper_Status_UpgradingFishstrap);

            try
            {
#if DEBUG_UPDATER
                string downloadLocation = Path.Combine(Paths.TempUpdates, "Fishstrap.exe");
        ...
        {
            Utilities.CloseRobloxPlayerProcesses(true, logIdent: "Bootstrapper::KillRobloxPlayers");
        }
        ...
        private static void StartBackgroundUpdater()
        {
            ...
            if (Utilities.DoesMutexExist("Fishstrap-BackgroundUpdater"))
            {
                ...
                catch (Exception ex)
                {
                    ...
                    if (ex.GetType() == typeof(ChecksumFailedException))
                    {
                        Frontend.ShowConnectivityDialog(
                            ...
                            String.Format(Strings.Dialog_Connectivity_UnableToDownloadReason, "[https://github.com/fishstraplabs/fishstrap/wiki/Fishstrap-is-unable-to-download-Roblox](https://github.com/fishstraplabs/fishstrap/wiki/Fishstrap-is-unable-to-download-Roblox)"),
