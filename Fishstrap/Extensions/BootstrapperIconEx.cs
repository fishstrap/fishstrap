...
namespace Fishstrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconFishstrapBootstrapper,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconFishstrapBootstrapper;
            }

            return icon switch
            {
                //BootstrapperIcon.IconFishstrap => Properties.Resources.IconFishstrap,
                BootstrapperIcon.IconFishstrapBootstrapper => Properties.Resources.IconFishstrapBootstrapper,
                ...
                _ => Properties.Resources.IconFishstrapBootstrapper
            };
        }
    }
}
