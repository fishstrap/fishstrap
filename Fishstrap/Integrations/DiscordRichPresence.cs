...
using Fishstrap.Models.RobloxApi;
using DiscordRPC;

namespace Fishstrap.Integrations
{
    public class DiscordRichPresence : IDisposable
    {
        ...
        private void ProcessSetRichPresence(Message message, bool implicitUpdate)
        {
            ...
            Models.FishstrapRPC.RichPresence? presenceData;
            ...
            try
            {
                presenceData = message.Data.Deserialize<Models.FishstrapRPC.RichPresence>();
            }
            catch (Exception)
            {
        ...
        public async Task<bool> SetCurrentGame()
        {
            ...
            // this is used for configuration from FishstrapRPC
