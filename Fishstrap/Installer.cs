...
namespace Fishstrap
{
    internal class Installer
    {
        ...
        public string FishstrapInstallDirectory = Path.Combine(Paths.LocalAppData, "Fishstrap"); // default directory for fishstrap
        ...
        public bool ImportSettings = Directory.Exists(Path.Combine(Paths.LocalAppData, "Fishstrap")); // if fishstrap isnt detected this will be set to false
        ...
        public void DoInstall()
        {
            ...
            string? selectedLocale = App.PendingLocaleSelection;

            if (selectedLocale is not null && !Locale.SupportedLocales.ContainsKey(selectedLocale))
                selectedLocale = null;
            ...
            // only register player, for the scenario where the user installs fishstrap, closes it,
            ...
            {
                App.Settings.Prop.Locale = selectedLocale;
                Locale.Set(selectedLocale);
                App.PendingLocaleSelection = null;
            }
        ...
        public static void HandleUpgrade()
        {
            ...
            if (existingVer is not null)
            {
                ...
                if (Utilities.CompareVersions(existingVer, "2.8.0") == VersionComparison.LessThan)
                {
                    ...
                    string oldStartPath = Path.Combine(Paths.WindowsStartMenu, "Fishstrap");
                    ...
                    Registry.CurrentUser.DeleteSubKeyTree("Software\\Fishstrap", false);
