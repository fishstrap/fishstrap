...
namespace Fishstrap
{
    public class LaunchSettings
    {
        ...
        public LaunchFlag DisableRobloxAutoStartFlag { get; } = new("disablerobloxautostart");

        public LaunchFlag EnableRobloxAutoStartFlag { get; } = new("enablerobloxautostart");

#if DEBUG
        public bool BypassUpdateCheck => true;
#else
        public bool BypassUpdateCheck => UninstallFlag.Active || WatcherFlag.Active || DisableRobloxAutoStartFlag.Active || EnableRobloxAutoStartFlag.Active;
#endif
