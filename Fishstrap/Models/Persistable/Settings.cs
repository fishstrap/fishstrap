...
namespace Fishstrap.Models.Persistable
{
    public class Settings
    {
        ...
        // fishstrap configuration
        public BootstrapperStyle BootstrapperStyle { get; set; } = BootstrapperStyle.FluentAeroDialog;
        public BootstrapperIcon BootstrapperIcon { get; set; } = BootstrapperIcon.IconFishstrapBootstrapper;
        ...
        public bool KillRobloxOnWindowClose { get; set; } = false;
        public bool DisableRobloxAutoStart { get; set; } = false;
