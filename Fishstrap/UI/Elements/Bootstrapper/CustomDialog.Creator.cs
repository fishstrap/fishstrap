...
namespace Fishstrap.UI.Elements.Bootstrapper
{
    public partial class CustomDialog
    {
        ...
        {
            ["FishstrapCustomBootstrapper"] = HandleXmlElement_FishstrapCustomBootstrapper_Fake,
        ...
        private void HandleXmlBase(XElement xml)
        {
            ...
            if (xml.Name != "FishstrapCustomBootstrapper")
                throw new Exception("XML root is not a FishstrapCustomBootstrapper");

            if (xml.Attribute("Version")?.Value != Version.ToString())
                throw new Exception("Unknown FishstrapCustomBootstrapper version");
            ...
            // handle root
            HandleXmlElement_FishstrapCustomBootstrapper(this, xml);
